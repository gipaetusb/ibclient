...
val c = new FutureContract(symbol="BZ", expiry="20201230", exchange="NYMEX")
val futContractDetails = ibc.contractDetails(c)
val contractDetails = block(futContractDetails)

val startDate = new DateTime(2020, 12, 15, 15, 0).toDate
val endDate = new DateTime(2020, 12, 16, 15, 0).toDate
